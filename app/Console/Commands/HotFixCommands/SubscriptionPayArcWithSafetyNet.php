...
class SubscriptionPayArcWithSafetyNet extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:runMissedSubs';
     ...
     * @var string
     */
    protected $description = 'This imports and runs subscriptions missed in 2019';
    ...
    public function handle()
    {
        ...
        $subs_to_do = $this->parseCsv(public_path() . '/csv/missed_subs.csv');
        ...
        $user_subs_query = 'SELECT
                    ...
                    WHERE
                        ...
                        AND "public"."orderItem".created_date > \'2020-03-01\'
...
////                                            $nmiResult = NMIGateway::processPayment($tokenRes->Value, $payment_method->firstname, $payment_method->lastname, $payment_method->expMonth, $payment_method->expYear, $payment_method->cvv, $orderTotal, $billingAddress->address1, $billingAddress->city, $billingAddress->stateprov, $billingAddress->postalcode, $billingAddress->countrycode);
                                ...
                                $nmiResult = \App\Helper::networkMerchants($user, $tokenRes->Value, $payment_method->expYear, $payment_method->expMonth, $product, $billingAddress, $orderTotal, 11);
