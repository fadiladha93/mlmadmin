...
class SubscriptionPayArcNoSafetyNet extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:runMissedSubsNoSafety';
     ...
     * @var string
     */
    protected $description = 'This imports and runs subscriptions missed without checking if the user has a recent sub';
    ...
    public function handle()
    {
        ...
        $subs_to_do = $this->parseCsv(public_path() . '/TG-Payarc1.csv');
