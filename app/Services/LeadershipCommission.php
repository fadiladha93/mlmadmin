 ...
 */
class LeadershipCommission extends DynamicCompressionCommission
{
    ...
    public function calculateCommission($fromDate, $toDate)
    {
        ...
        $doTransaction = env('LEADERSHIP_COMMISSION_USE_TRANSACTION', true);
        ...
        try {
            ...
            Log::info('Commission completed.', [get_called_class()]);
    ...
    {
        return \App\Models\LeadershipCommission::where('end_date', '=', $endDate)
            ->first();
    }
