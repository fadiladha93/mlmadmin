                        ...
                        <div class="m-portlet__head-caption">
                            <div class="m-portlet__head-title">
                                <h3 class="m-portlet__head-text">
                                    Travel Commissions Import
                                </h3>
                            </div>
                        </div>
                    </div>
                    <div class="m-portlet__body">
                        <form id="importTsbForm" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="m-form m-form__section--first m-form--label-align-right">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-md-4 offset-5">
                                        <button type="submit" id="btnImportTsb" class="btn btn-info btn-sm m-btn--air">Import</button>
                                    </div>
                                </div>
                            </div>
                        </form>
