    ...
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__head">
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    <h3 class="m-portlet__head-text">
                        Monthly Rank Achievers for Sapphire
                    </h3>
                </div>
            </div>
            <div class="m-portlet__head-tools">
                ...
                <button class="btn btn-info btn-sm m-btn--air" id="btnFilterSapphireMonthly">View</button>
            </div>
        </div>
        <div class="m-portlet__body">
            <table class="table table-striped- table-bordered table-hover table-checkable" id="dt_sapphire_monthly">
                <thead>
                    <tr>
                        <th>Dist ID</th>
                        <th>First Name</th>
