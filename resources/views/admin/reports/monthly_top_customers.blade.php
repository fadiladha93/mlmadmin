...
<div class="m-content">
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__head">
            ...
            <form id="frmMonthlyTopCustomersFilter" style="display: flex;">
                <div class="m-portlet__head-tools">
                    ...
                    <button class="btn btn-info btn-sm m-btn--air" id="btnFilterTopCustomers">View</button>&nbsp;
                    @if (\App\AdminPermission::export_reports())
                        <button class="btn btn-info btn-sm m-btn--air" id="exp_monthly_top_customers">Export</button>
                    @endif
                </div>
            </form>
        </div>
        <div class="m-portlet__body">
            <table class="table table-striped- table-bordered table-hover table-checkable" id="dt_monthly_top_customers">
                <thead>
                    <tr>
                        <th>Dist ID</th>
                        <th>First Name</th>
