<div>
    Please enter the credit card data you wish to use for<br/>
    your selected promotional package.
</div>
...
<div style="margin-top:15px;">
    ...
    <div class="pull-right">
        <a currentStep="6" class="btn m-btn m-btn--air btn-warning btnNextStep">Next</a>
    </div>
