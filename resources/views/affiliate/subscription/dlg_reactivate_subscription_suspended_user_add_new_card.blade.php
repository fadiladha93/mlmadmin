        ...
        <div class="modal-body dlgQuestionList">
            ...
            <div class="cm-body" style="background: #4aafd1">
                <div class="cm-body-inner">
                    <div class="card-wrap" id=frmSubscriptionReactivateAddCardSuspendedUser>
                        <div class="card-lt">
                        ...
                        <div class="submit-cart submit-btn-grp">
                            ...
                            <button id="btnAddNewCardOnSubscriptionReactivateSuspendedUser" class="yellow-btn">SUBMIT</button>
                        </div>
                    </div>
                </div>
            </div>
