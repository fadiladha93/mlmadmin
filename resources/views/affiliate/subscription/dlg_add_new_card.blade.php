    ...
    <div class="modal-content">
        <div class="modal-body dlgQuestionList">
            <iframe width="1" height="1" frameborder="0" scrolling="no"
                    src="{{Config::get('api_endpoints.KOUNTIFrameURL')}}/logo.htm?m={{Config::get('api_endpoints.kount.KOUNTMerchantID')}}&s={{$sessionId}}">
            </iframe>
            ...
            <div class="cm-body" style="background: #4aafd1">
                <div class="cm-body-inner">
                    <div class="card-wrap" id=frmSubscriptionAddCard>
                        <div class="card-lt">
                        ...
                        <div class="submit-cart submit-btn-grp">
                            ...
                            <button id="btnAddNewCardOnSubscription" class="yellow-btn">SUBMIT</button>
                        </div>
                    </div>
                </div>
            </div>
