        ...
        <div class="row m-row--no-padding" style="align-items: center;">
            ...
            <div class="col-sm-7 m--align-right ri-qv-sec">
                <div class="row top-producing">
                    <div class="col-md-12">
                        <span class="m-widget1__number m--font-{{$font[$k]}} ri-qv-value">{{number_format($c->qv_contribution)}} / {{ number_format($c->min_qv) }}</span>
                        <span class="m-widget1__desc ri-qv-desc">QV</span>
                    </div>
                </div>
            </div>
        </div>
