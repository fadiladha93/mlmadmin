                    ...
                    <div class="order-detail-wrap">
                        <div class="order-details">
                            ...
                            <div class="coupon-code" style="margin-top: 20px">
                                ...
                                <div class="coupn-btn">
                                    <input type="button" id="btnApplyCheckOutBoomerangCoupon" class="yellow-btn"
                                           value="Apply">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="submit-cart submit-btn-grp" style="margin-top:30px">
                            @if ($product->id == 15)
                                <button data-id="1" class="blue-btn" id="btnBackCheckOutPaymentIbuumerangPacks">BACK</button>
                                <button class="yellow-btn" id="btnConfirmCheckOutPaymentIbuumerangPacks">SUBMIT</button>
                            @else
                                <button class="blue-btn" id="btnBackCheckOutGeneric">CLOSE</button>
                                <button class="yellow-btn" id="btnConfirmCheckOutPaymentGeneric">SUBMIT</button>
                            @endif
                        </div>
                    </div>
                </div>
