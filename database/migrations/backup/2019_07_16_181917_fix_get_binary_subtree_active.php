...
class FixGetBinarySubtreeActive extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement('DROP FUNCTION IF EXISTS public.get_active_subtree_users(integer, integer, timestamp without time zone)');
...
begin
   ...
   END LOOP;
    ...
    {
        DB::statement('DROP FUNCTION IF EXISTS public.get_active_subtree_users(integer, integer, timestamp without time zone, character varying)');
