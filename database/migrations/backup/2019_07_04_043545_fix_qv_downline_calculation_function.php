...
class FixQvDownlineCalculationFunction extends Migration
{
    /**
     * Run the migrations.
     *
...
CREATE OR REPLACE FUNCTION public.calculate_month_downline_qv(from_date timestamp without time zone, to_date timestamp without time zone)
    RETURNS void
    LANGUAGE \'plpgsql\'
