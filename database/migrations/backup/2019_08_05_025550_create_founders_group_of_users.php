...
class CreateFoundersGroupOfUsers extends Migration
{
    /**
     * Run the migrations.
     *
...
$BODY$;
    ...
    {
        DB::statement('UPDATE users SET founder = NULL;');
        DB::statement('UPDATE users SET founder = 1 WHERE id = 17424;');
...
begin
	...
	ELSIF pack_id = 4 THEN
	    ...
	    IF purchase_date <= \'2019-08-01 23:59:59\' AND NOW() < (purchase_date + interval \'1 year\') THEN
	        pack_percent := 0.2;
	    END IF;
