...
class ForceUsersBinaryQualifiedCheck extends Migration
{
    /**
     * Run the migrations.
     *
...
begin
    ...
    LOOP
		...
		IF is_binary_commission_user(buser.user_id, to_date) THEN
			IF (active_left > 0 AND active_right > 0) OR buser.distid IN (\'A1637504\',\'A1357703\',\'TSA9834283\',\'TSA0707550\',\'TSA5138270\') THEN
