...
class RestoreCarryoverFlushing extends Migration
{
    /**
     * Run the migrations.
     *
...
buser RECORD;
	...
	is_carryover_moving boolean := false;
	moving_left_carryover numeric := 0;
	moving_right_carryover numeric := 0;
...
begin
    ...
    LOOP
		...
		IF is_carryover_moving THEN
		    moving_left_carryover := user_left_carryover + t_left_carryover;
		    moving_right_carryover := user_right_carryover + t_right_carryover;
		END IF;
		...
		VALUES (
			buser.user_id,
			moving_right_carryover,
			moving_left_carryover,
